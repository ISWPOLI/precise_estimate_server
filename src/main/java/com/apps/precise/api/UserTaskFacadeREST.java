...
import com.apps.precise.entities.UserTask;
 ...
 */
@Stateless
@Path("com.apps.precise.entities.usertask")
public class UserTaskFacadeREST extends AbstractFacade<UserTask> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, UserTask entity) {
        super.edit(entity);
    }
    ...
    public UserTask find(@PathParam("id") Integer id) {
